      ...
      <div className="card" style={{ marginBottom: '1.5rem', padding: '1.25rem' }}>
        ...
        <div className="flex gap-sm mt-md">
           <div className="form-group" style={{ marginBottom: 0, flex: 1 }}>
             <input type="text" className="form-input" name="entityId" placeholder={t('audit.filter.entity_id_ph')} value={filters.entityId} onChange={handleFilterChange} />
           </div>
           <button className="btn btn-secondary" onClick={() => {
             setFilters({ entityType: '', actionType: '', startDate: '', endDate: '', actorSearch: '', entityId: '' });
             setPage(1);
